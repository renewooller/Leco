...
import com.lemu.gui.musicArea.MorphEndListener;
import com.lemu.music.morph.MorphFactory;
import com.lemu.music.morph.ParamMorpher;
...
public abstract class BasicMorphMusicGen extends MusicGenerator {
     ...
     * 
     * @see com.lemu.music.MorphTracker#getPos()
     */
...
//      create mtracker
     ...
     * Also
     * 
     * {@link com.lemu.music.LScore#mergeLScores(LScore, LScore) 
     */
     ...
     * @see com.lemu.music.MusicGenerator#tickScore(TickEvent)
     */
