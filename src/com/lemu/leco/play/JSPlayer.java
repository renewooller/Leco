 ...
 * 
 */
public class JSPlayer implements Playable, UserModifiedBeatListener,
		MetaEventListener {
	...
	private ArrayList<PrePostPlayerEventListener> prepoplavlis = new ArrayList<PrePostPlayerEventListener>(
			10);
	...
	public JSPlayer() {
		super();
		initSequencer();
		//this.midiSynth.addPlayable((Playable) this);
		beatTracker = new LPlayerBeatTracker();
		beatTracker.construct(new ParameterMap().construct(32, 16777216, 512,
				"scope"));
		// user generated beat changes
