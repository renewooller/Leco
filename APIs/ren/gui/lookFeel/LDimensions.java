 ...
 * @author  Rene Wooller
 */
public class LDimensions {
    private static double hzf = 0.5;
    ...
    private static int horizontalUnit1600 = (int)(41*hzf);
    private static int horizontalUnit1280 = (int)(30*hzf);
    private static int horizontalUnit1024 = (int)(30*hzf);
    private static int horizontalUnit800 = (int)(28*hzf);
   ...
   //     System.out.println("dfw = " + dfw);
    ...
    public static Dimension backgroundPanel() {
        if(CustomDimensions.screenSize.width >= 1600) {
            return new Dimension(800, CustomDimensions.screenSize.height-87);
        } else if( CustomDimensions.screenSize.width >= 1280) {
            return new Dimension(630, CustomDimensions.screenSize.height-87);
        } else if( CustomDimensions.screenSize.width >= 1024) {
            return new Dimension(630, CustomDimensions.screenSize.height-87);
        } else if( CustomDimensions.screenSize.width >= 800) {
            return new Dimension(610, CustomDimensions.screenSize.height-87);
        }
    ...
    public static Dimension mixerMute() {
        ...
        //height of mute
        int muteHeight = 20;
        if (CustomDimensions.screenSize.width >= 1600) //1600x1200
            cbDimension = new Dimension(41, muteHeight); 
        else if(CustomDimensions.screenSize.width >= 1280) //1280x1024
            cbDimension = new Dimension(31, factor(muteHeight, 1024, 1200)); 
        else if(CustomDimensions.screenSize.width >= 1024) //1024x768
