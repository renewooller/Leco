...
public class MidiSynth implements MetaEventListener {
    ...
    */
    public void play(Score score) throws InvalidMidiDataException {
        ...
        //m_sequencer.setSlaveSyncMode(Sequencer.SyncMode.MIDI_TIME_CODE);
        m_sequencer.start();
    ...
    //	System.out.println("callback fired : " + id + " player at " +  this.player.getBeatTracker().at());
    }
    ...
    */
    protected void scoreToSeq(Score score) throws InvalidMidiDataException {
        ...
        //Create the Sequence
        if(seq == null)
        	seq = new Sequence(Sequence.PPQ, m_ppqn);
        else
        	empty();
        ...
        while(parts.hasMoreElements()) {
            ...
            if (currChannel > 16) {
                InvalidMidiDataException  ex = new
    ...
    private void addCallBacksToSeq(double longestTime) {
    	 int countCallTime = 0;
         //long resLong = this.player.getBeatTracker().getRes()*this.m_ppqn;
         while((long)(countCallTime*this.player.getBeatTracker().getRes()*this.m_ppqn) < longestTime) {
         	countCallTime++;
        // 	this.addCallback(ci, countCallTime);
    ...
    private void addEndEvent(Track longestTrack, double longestTime) throws InvalidMidiDataException {
        ...
        if (longestTime > 0.0 && longestTrack != null) {
            ...
            MidiEvent evt = new MidiEvent(msg, (long)longestTime + 100); //leave some space for reverb tail
    ...
    public double getBeats() {
    	if(this.m_sequencer == null) return this.startPos*1.0/this.m_ppqn*1.0; // not yet initialised
